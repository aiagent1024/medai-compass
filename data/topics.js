...
const TOPICS = [
  ...
  },
  {
    ...
    intro: [
      ...
      "These then need to be folded back into the medical-device risk file: <strong>AAMI TIR34971</strong> is where adversarial-input and bias hazards become documented risk controls, and <strong>ISO/IEC 42001</strong> expects the organisation to identify and manage risks such as prompt injection, adversarial testing, input validation, bias detection and content filtering as part of its AI management system.",
    ],
    keyPoints: [
